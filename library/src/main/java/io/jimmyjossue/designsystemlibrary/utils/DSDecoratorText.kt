...
@Composable
internal fun List<DSDecoratorText>.getColor(): Color {
    val currentColors = LocalColors.current
    return when {
        this.contains(DSDecoratorText.PRIMARY) -> currentColors.primary
        this.contains(DSDecoratorText.ACCENT) -> currentColors.accent
        this.contains(DSDecoratorText.TYPOGRAPHY) -> currentColors.typography
        this.contains(DSDecoratorText.SUCCESS) -> currentColors.success
        this.contains(DSDecoratorText.WARNING) -> currentColors.warning
        this.contains(DSDecoratorText.ERROR) -> currentColors.error
